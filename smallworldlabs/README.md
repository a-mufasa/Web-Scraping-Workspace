...
```
uv run python smallworldlabs/getVendors.py [HTML file]
```
...
```
uv run python smallworldlabs/scrape.py [vendor IDs file] [base url] [optional output folder]
```
...
```
uv run python smallworldlabs/parse.py [base url]
```
